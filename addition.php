...
<section class="big-slider-sec">
	<div class="big-slider">
		<div class="big-slide big-slide--blured" style="background-image: url('../img/big-slider/addition.jpg')">
			<div class="container">
				<div class="big-slide__img">
					<img src="img/big-slider/addition.jpg" alt="">
				</div>
				<div class="big-slide__info">
					<p class="h1">Аквагрим</p>
