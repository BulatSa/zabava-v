...
<section class="big-slider-sec">
	<div class="big-slider">
		<div class="big-slide big-slide--blured" style="background-image: url('../img/big-slider/calendar-2.jpg')">
			<div class="container">
				<div class="big-slide__img">
					<img src="img/big-slider/calendar-2.jpg" alt="">
				</div>
				<div class="big-slide__info">
					<p class="h1">1 сентября в школе</p>
...
<section class="animators-list-sec def-sec-waved">
	<div class="animators-list container">
		<div class="page-title">
			<p class="h2">Интерактивные программы
				для&nbsp;школьных линеек на&nbsp;1&nbsp;сентября</p>
		</div>
		<div class="additions-list">
			<div class="addition anim">
				...
				<span class="addition__img">
					...
					<span class="h5">День знаний в Парке Юрского периода</span>
...
<section class="animators-list-sec def-sec-waved-top">
	<div class="animators-list container">
		<div class="page-title">
			<p class="h2">Интерактивные программы
				для&nbsp;класса на&nbsp;1&nbsp;сентября</p>
		</div>
		<div class="additions-list">
			<div class="addition anim">
				<a href="#">
...
<section class="form-bottom-sec def-sec-waved-top wave-blue-top" style="background-image: url('../img/form-bottom/bg-calendar.jpg')" id="form-bottom">
